...
def parse_args():
    ...
    parser.add_argument('--data-dir', help='the dir to fetch the data from')
...
def main():
    ...
    cfg.data.test.ann_file = cfg.data_root + 'annotations/instances_val.json'
    ...
    cfg.dump(osp.join(cfg.data_root, osp.basename(args.config)))
